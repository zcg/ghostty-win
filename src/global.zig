...
const fontconfig = if (build_config.font_backend.hasFontconfig()) @import("fontconfig") else void;
const glslang = @import("glslang");
const harfbuzz = if (build_config.font_backend.hasHarfbuzz()) @import("harfbuzz") else void;
